        ...
        <div className={classes.root} id="header">
            <ThemeProvider theme={theme}>
                ...
                <Container maxWidth="sm" component="main" className={classes.heroContent}>
                    <Typography className={classes.mainmess} component="h1" variant="h2" align="center" gutterBottom>
                        Pricing
                    </Typography>
                </Container>
                        ...
                        {tiers.map((tier) => (
                            <Grid item key={tier.title} xs={12} sm={tier.title === 'Enterprise' ? 12 : 6} md={4}>
                                <Card>
                                    ...
                                    <CardActions>
                                        <Button to={tier.whereto} component={Link} fullWidth variant={tier.buttonVariant} color='primary'>
                                            {tier.buttonText}
                                        </Button>
                                    </CardActions>
                                </Card>
